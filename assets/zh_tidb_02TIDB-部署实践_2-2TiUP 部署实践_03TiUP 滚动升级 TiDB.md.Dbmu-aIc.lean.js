import{_ as a,c as n,a5 as p,o as t}from"./chunks/framework.PytyN_aB.js";const b=JSON.parse('{"title":"TiDB-TiUP工具集群滚动升级","description":"","frontmatter":{},"headers":[],"relativePath":"zh/tidb/02TIDB-部署实践/2-2TiUP 部署实践/03TiUP 滚动升级 TiDB.md","filePath":"zh/tidb/02TIDB-部署实践/2-2TiUP 部署实践/03TiUP 滚动升级 TiDB.md"}'),i={name:"zh/tidb/02TIDB-部署实践/2-2TiUP 部署实践/03TiUP 滚动升级 TiDB.md"};function e(l,s,d,c,r,o){return t(),n("div",null,s[0]||(s[0]=[p(`<h1 id="tidb-tiup工具集群滚动升级" tabindex="-1">TiDB-TiUP工具集群滚动升级 <a class="header-anchor" href="#tidb-tiup工具集群滚动升级" aria-label="Permalink to &quot;TiDB-TiUP工具集群滚动升级&quot;">​</a></h1><p>时间：2020-12-25</p><blockquote><p><a href="#获取升级版本镜像包">获取升级版本镜像包</a><br><a href="#升级前环境检查">升级前环境检查</a><br><a href="#将集群升级到指定版本">将集群升级到指定版本</a><br><a href="#TiUP工具滚动升级">TiUP工具滚动升级</a><br><a href="#验证集群升级">验证集群升级</a><br><a href="#常见问题解决方案">常见问题解决方案</a></p></blockquote><h2 id="获取升级版本镜像包" tabindex="-1">获取升级版本镜像包 <a class="header-anchor" href="#获取升级版本镜像包" aria-label="Permalink to &quot;获取升级版本镜像包&quot;">​</a></h2><p>方式一：<a href="https://pingcap.com/download-cn/community/" target="_blank" rel="noreferrer"><strong>TiDB社区版获取方式：https://pingcap.com/download-cn/community/</strong></a></p><p>方式二：联网TiUP服务器打包scp</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[tidb@tiup-tidb44 ~]$ tiup mirror clone tidb-community-server-v4.0.9-linux-amd64 v4.0.9 --os=linux --arch=amd64</span></span>

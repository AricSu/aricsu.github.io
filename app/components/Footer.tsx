...
const columns = [
	...
	},
	{
		...
		children: [
			...
			{ label: "Bilibili", to: "https://space.bilibili.com/318184941", target: "_blank" },
			{ label: "Youtube", to: "https://www.youtube.com/@askaric", target: "_blank" },
			{ label: "Instagram", to: "https://www.instagram.com/aricsu36/", target: "_blank" },
		],
	},
];

import{_ as n,c as a,o as p,a5 as i}from"./chunks/framework.JWlnoUZ4.js";const k=JSON.parse('{"title":"TiDB-TiUP工具集群离线部署方案","description":"TiDB-TiUP工具集群离线部署方案","frontmatter":{"title":"TiDB-TiUP工具集群离线部署方案","description":"TiDB-TiUP工具集群离线部署方案"},"headers":[],"relativePath":"zh/work/tidb/02TIDB-部署实践/2-2TiUP 部署实践/01TiUP 离线部署 TiDB.md","filePath":"zh/work/tidb/02TIDB-部署实践/2-2TiUP 部署实践/01TiUP 离线部署 TiDB.md"}'),l={name:"zh/work/tidb/02TIDB-部署实践/2-2TiUP 部署实践/01TiUP 离线部署 TiDB.md"};function t(e,s,c,d,r,o){return p(),a("div",null,s[0]||(s[0]=[i(`<h1 id="tidb-tiup工具集群离线部署方案" tabindex="-1">TiDB-TiUP工具集群离线部署方案 <a class="header-anchor" href="#tidb-tiup工具集群离线部署方案" aria-label="Permalink to &quot;TiDB-TiUP工具集群离线部署方案&quot;">​</a></h1><p>时间：2020-12-25</p><blockquote><ul><li><a href="#下载TiUP离线组件">下载TiUP离线组件</a></li><li><a href="#下载TiUP离线组件">TiKV数据盘挂载</a></li><li><a href="#配置topology配置文件">配置topology配置文件</a></li><li><a href="#部署TiDB集群">部署TiDB集群</a></li><li><a href="#检查集群状态">检查集群状态</a></li><li><a href="#TiUP卸载集群">TiUP卸载集群</a></li><li><a href="#常见错误解决">常见错误解决</a></li></ul></blockquote><blockquote><p><strong>IP规划</strong></p></blockquote><table tabindex="0"><thead><tr><th>IP地址</th><th>Role信息</th><th>备注</th></tr></thead><tbody><tr><td>192.168.169.41</td><td>pd+tikv+tidb+cdc</td><td>部署TiUP主机</td></tr><tr><td>192.168.169.42</td><td>pd+tikv+tidb+cdc+prometheus+grafana+alertmanager</td><td></td></tr><tr><td>192.168.169.43</td><td>pd+tikv+tidb+cdc</td><td></td></tr><tr><td>192.168.169.44</td><td>tiflash</td><td></td></tr></tbody></table><h2 id="下载tiup离线组件" tabindex="-1">下载TiUP离线组件 <a class="header-anchor" href="#下载tiup离线组件" aria-label="Permalink to &quot;下载TiUP离线组件&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[root@tiup-tidb41 ~]# useradd tidb</span></span>
